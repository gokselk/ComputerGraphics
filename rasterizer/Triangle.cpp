...
// setters
[[maybe_unused]] void Triangle::setFirstVertexId(int vid) {
    this->vertexIds[0] = vid;
}

[[maybe_unused]] void Triangle::setSecondVertexId(int vid) {
    this->vertexIds[1] = vid;
}

[[maybe_unused]] void Triangle::setThirdVertexId(int vid) {
